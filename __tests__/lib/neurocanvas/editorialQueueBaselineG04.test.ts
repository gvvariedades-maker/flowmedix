...
describe('editorialQueueBaselineG04', () => {
  it('congela as contagens medidas em main limpo pós-IDECAN (#59)', () => {
    expect(EDITORIAL_QUEUE_BASELINE_G04.baseline_id).toBe('G0.4');
    expect(EDITORIAL_QUEUE_BASELINE_G04.total_cases).toBe(345);
    expect(EDITORIAL_QUEUE_BASELINE_G04.cluster_count).toBe(110);
    expect(EDITORIAL_QUEUE_BASELINE_G04.official_lane_count).toBe(16);
