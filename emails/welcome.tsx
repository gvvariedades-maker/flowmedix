...
export function WelcomeEmail({ firstName }: WelcomeEmailProps) {
  ...
  return (
    <BaseLayout preview="Bem-vindo ao AVANT — estudo reverso para Técnico de Enfermagem" brandTagline="Estudo reverso · Técnico de Enfermagem">
      <Section
        style={{
          padding: '24px 22px',
          borderRadius: '16px',
      ...
      >
        ...
        <Text style={{ margin: '0 0 12px', color: '#e2e8f0', fontSize: '16px', lineHeight: '26px' }}>
          Você entrou no AVANT — estudo reverso feito para Técnicos de Enfermagem em concursos
