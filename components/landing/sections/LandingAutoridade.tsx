  ...
  return (
    <section className="bg-white px-4 py-14 sm:px-6">
      <div className="card-elevated mx-auto max-w-2xl rounded-2xl border-slate-200 bg-[#f1f5f9] p-10 text-center shadow-sm">
        <div
          className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full border-2 border-[#F26522]/40 bg-[#F26522]/15 text-xl font-black text-[#9A3412]"
          aria-hidden
        >
          {LANDING_AUTORIDADE.initials}
        </div>
        <p className="text-sm font-bold uppercase tracking-wide text-[#9A3412]">
