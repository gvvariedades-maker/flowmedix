...
export const SELECT_ITEM_EDITORIAL = joinClasses(
  'rounded-lg text-slate-700 focus:bg-[rgba(34, 197, 94,0.08)] focus:text-[#166534]',
  '[&>span:first-child]:text-[#166534]',
);
...
export const SELECT_TRIGGER_EDITORIAL_PANEL = joinClasses(
  ...
  'focus:outline-none focus:ring-2 focus:ring-[rgba(34, 197, 94,0.35)] focus:ring-offset-2 focus:ring-offset-white',
