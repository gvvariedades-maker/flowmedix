...
export const GoldenRule = ({ content, theme, layoutVariant = 'center' }: GoldenRuleProps) => {
  ...
  if (variant === 'center') {
    return (
      <div className="w-full min-h-full min-w-0 flex items-center justify-center p-4 md:p-8 relative overflow-y-auto custom-scrollbar">
  ...
  if (variant === 'compact') {
    return (
      <div className="w-full min-h-full min-w-0 flex items-center justify-center p-6 md:p-10 relative overflow-y-auto custom-scrollbar">
  ...
  if (variant === 'minimal') {
    return (
      <div className="w-full min-h-full min-w-0 flex items-center justify-center p-8 relative overflow-y-auto custom-scrollbar">
  ...
  if (variant === 'banner') {
    return (
      <div className="w-full min-h-full min-w-0 flex items-center justify-center p-4 relative overflow-y-auto custom-scrollbar">
