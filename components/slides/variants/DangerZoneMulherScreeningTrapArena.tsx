...
import { inferScreeningTrapZones, SCREENING_AGE_MARKERS } from '@/lib/slides/mulherPapanicolauSlideUtils';
import {
  BoardChrome,
  PolarityPanel,
  boardTone,
...
/** Régua etária local — escala 18–64, pegadinha × correto (rastreio colo). */
...
/** Arena rastreio colo — PolarityPanel trap×correto (Fábrica G2). */
export function DangerZoneMulherScreeningTrapArena({
  ...
  return (
    <BoardChrome
      theme={theme}
      eyebrow={content || 'Rastreio · pegadinhas'}
