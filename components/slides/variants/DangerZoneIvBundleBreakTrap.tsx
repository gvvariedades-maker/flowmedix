...
import { inferIvBundleBreakSlot } from '@/lib/slides/puncaoBranchSlideUtils';
...
export function DangerZoneIvBundleBreakTrap({
  content,
  items,
  theme,
  footerRule,
    ...
    () =>
      items.map((item, index) => {
        ...
        return {
          ...
          detail,
          correct,
          slot: inferIvBundleBreakSlot(label, detail, correct),
          index,
        };
      }),
    [items],
