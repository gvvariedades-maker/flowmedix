...
export const DANGER_ZONE_VARIANT_CAPABILITIES: Record<string, DangerZoneVariantCapabilities> = {
  ...
  'calendar-mismatch': { dangerTapReveal: true, defaultBulletStyle: 'x_icon' },
  ...
  'farmaco-clinico-trap': { dangerTapReveal: true, defaultBulletStyle: 'x_icon' },
  'farmaco-trap': { dangerTapReveal: true, defaultBulletStyle: 'x_icon' },
  ...
  'pni-trap-chips': { dangerTapReveal: true, defaultBulletStyle: 'x_icon' },
  ...
  'temperature-mismatch': { dangerTapReveal: true, defaultBulletStyle: 'x_icon' },
  ...
  'vitals-classify-arena': { dangerTapReveal: true, defaultBulletStyle: 'x_icon' },
};
