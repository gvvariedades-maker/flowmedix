...
export const DANGER_ZONE_VARIANT_CAPABILITIES: Record<string, DangerZoneVariantCapabilities> = {
  ...
  'adolescent-violence-calendar': { dangerTapReveal: false, defaultBulletStyle: 'x_icon' },
  'adolescent-mental-step-trap': { dangerTapReveal: false, defaultBulletStyle: 'x_icon' },
  'adolescent-dev-budget-checklist': { dangerTapReveal: false, defaultBulletStyle: 'x_icon' },
  'adolescent-generic-versus-blocks': { dangerTapReveal: false, defaultBulletStyle: 'x_icon' },
