...
const Dyn_adolescent_exceto_isolate_board = dynamic(
  () =>
    loadNamedVariant(
      () => import('../variants/LogicFlowAdolescentExcetoIsolateBoard') as Promise<Record<string, unknown>>,
      'LogicFlowAdolescentExcetoIsolateBoard',
    ),
  { ssr: true, loading: () => null },
);
