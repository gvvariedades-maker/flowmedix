...
const ctaButtonClass =
  'inline-flex shrink-0 items-center justify-center gap-1.5 rounded-xl bg-gradient-to-b from-[#FF8A3D] via-[#F26522] to-[#D45212] px-2.5 py-2 text-xs font-black uppercase tracking-wider text-white shadow-lg shadow-[#F26522]/25 transition-all hover:scale-[1.02] hover:brightness-95 min-[400px]:gap-2 min-[400px]:px-3 sm:gap-2 sm:px-4 sm:py-2.5 sm:text-sm';
