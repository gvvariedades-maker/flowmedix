-- Vitrine: totalNeuroSlides por assunto (soma real de reverse_study_slides / study_slides).
...
COMMENT ON FUNCTION public.get_vitrine_page(uuid, int, text, text, text, text[], text[]) IS
  'Vitrine paginada por titulo_aula com facets e totalNeuroSlides por assunto. Uso: service_role.';
