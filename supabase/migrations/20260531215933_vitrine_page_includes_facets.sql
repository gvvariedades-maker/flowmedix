-- Fase 2: get_vitrine_page retorna facets (bancas/assuntos) no mesmo JSON.
-- Paridade com get_vitrine_facets sobre accessible_modulos; assuntos respeitam p_bancas/p_banca.
...
BEGIN
  ...
  INTO v_total_modulos, v_total_groups, v_groups, v_facets;
...
COMMENT ON FUNCTION public.get_vitrine_page(uuid, int, text, text, text, text[], text[]) IS
  'Vitrine paginada por titulo_aula com facets embutidos (bancas/assuntos). Uso: service_role.';
