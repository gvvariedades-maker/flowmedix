  ...
  switch (phase) {
    case 'fase0':
      return [
        ...
        `npm run audit:golden-anchor-gate -- --subtopico="${canonical}"`,
        `# Se gate=block: Criar âncoras: ${canonical} (skill avant-golden-anchor-bootstrap)`,
        `npm run anchor:brief -- --subtopico="${canonical}"`,
        '```',
        '',
