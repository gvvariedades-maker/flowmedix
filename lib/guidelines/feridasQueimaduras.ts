...
export const FERIDAS_QUEIMADURAS_MS: GuidelineTable = {
  ...
  entries: [
    ...
    {
      id: 'scq-tronco-anterior-18',
      label: 'Tronco anterior adulto',
      value: '18% na regra dos 9',
      detail: 'Tórax + abdome anterior — par com tronco posterior 18%.',
      sourceId: 'feridas-queimaduras-ms',
    },
    {
      id: 'scq-pegadinha-16',
      label: 'Pegadinha 16% SCQ',
      value: '16% não é segmento da regra dos 9 clássica',
      detail: 'Distrator em alternativas — tronco anterior correto = 18%.',
      sourceId: 'feridas-queimaduras-ms',
    },
    {
      id: 'scq-pegadinha-10',
      label: 'Pegadinha 10% SCQ',
      value: '10% não é segmento padrão da regra dos 9',
      detail: 'Distrator clássico em alternativas de SCQ.',
      sourceId: 'feridas-queimaduras-ms',
    },
    {
      id: 'scq-extensao-ate-10',
      label: 'SCQ até 10% adulto',
      value: 'até 10% SCQ — extensão pequena',
      detail: 'Não configura grande queimado nos critérios da prova.',
      sourceId: 'feridas-queimaduras-ms',
    },
    {
      id: 'scq-7pct-extensao',
      label: 'SCQ 7%',
      value: '7% SCQ — extensão insuficiente',
      detail: 'Distrator em critérios de grande queimado.',
      sourceId: 'feridas-queimaduras-ms',
    },
    {
    ...
    {
      id: 'scq-3grau-abaixo-2',
      label: '3º grau SCQ mínima',
      value: '3º grau abaixo de 2% SCQ',
      detail: 'Distrator — extensão mínima não define grande queimado nesta questão.',
      sourceId: 'feridas-queimaduras-ms',
    },
    {
      id: 'curativo-umido',
