#!/usr/bin/env python3
"""Extrai todas as questões de Verbos — tempos, modos e vozes do caderno PT interno."""
...
OUT = ROOT / "data/catalog-migration/verbos-tempos-modos-e-vozes-completo/extracted-source.json"
...
CARD_TITLE = "Verbos — tempos, modos e vozes"
VERBOS_ASSUNTOS = {
...
def suggest_slug(banca: str, instruction: str, tec_id: str) -> str:
    ...
    return f"{banca_slug}-verbos-{hint}-{tec_id}"[:90].rstrip("-")
