...
const TOC = [
  ...
  { id: 'passo-07', label: 'Acompanhar Progresso de estudo' },
...
const STEPS: {
  ...
  },
  {
    ...
    actionLabel: 'Ver Progresso de estudo após estudar',
    depois: 'Esse registro alimenta o Progresso de estudo e ajuda o Plano Diário a organizar revisões.',
  },
  {
    id: 'passo-07',
    n: '7',
    title: 'Acompanhe seu Progresso de estudo',
    file: 'seq-03.png',
    ...
    clique: 'No menu lateral, clique em “Progresso de estudo”. Para voltar ao estudo, use “Voltar para a Vitrine” no topo da página.',
    actionHref: '/progresso',
    actionLabel: 'Abrir Progresso de estudo',
    depois: 'Use estes números como referência diária e, para simulados, abra a área Meu desempenho.',
  },
  {
    id: 'passo-08',
    n: '8',
    ...
    clique: 'No menu lateral, clique em “Plano de Estudo Diário”. Se aparecer “Você está em dia”, use “Voltar para a Vitrine” no topo para estudar novos assuntos.',
