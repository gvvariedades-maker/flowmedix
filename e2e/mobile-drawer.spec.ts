...
test.describe('Dashboard — drawer mobile (Mais)', () => {
  ...
  test('D7 — modal questão bloqueia abertura do drawer', async ({ page }) => {
    ...
    const { garantirPainelAssuntoAberto, vitrineSubjectSheet, VITRINE_ASSUNTO_CTA_NAME } =
      await import('./helpers/vitrineE2e');
