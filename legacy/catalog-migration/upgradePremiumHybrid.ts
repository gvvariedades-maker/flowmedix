...
import { normalizeCurativosInstruction } from '@/legacy/catalog-migration/upgradePremiumCurativos';
import { isPuncaoSubtopico, normalizePuncaoInstruction } from '@/legacy/catalog-migration/upgradePremiumPuncao';
import {
  hasDedicatedPremiumBuilder,
  matchDedicatedPremiumBuilder,
} from '@/legacy/catalog-migration/upgradePremiumDedicatedRouter';
import {
  hasGenericSlides,
