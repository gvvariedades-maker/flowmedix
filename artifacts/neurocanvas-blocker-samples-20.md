...
## adm-tec-enfermagem-exames-complementares-1779563668619-6

- **Severidade:** S1
- **Pacote:** Procedimentos Diversos
- **Assinatura paths:** coleta-lote-01↔exames-complementares-lote-01+1
- **Lotes:** coleta-lote-01, exames-complementares-lote-01, taxonomy-agent-pending
...
- **Severidade:** S2
- **Pacote:** Infecções Sexualmente Transmissíveis (ISTs)
- **Assinatura paths:** atencao-basica-saude-da-familia-lote-01↔infeccoes-sexualmente-transmissiveis-ists-repair-lote-01
- **Lotes:** atencao-basica-saude-da-familia-lote-01, infeccoes-sexualmente-transmissiveis-ists-repair-lote-01
- **Manifest documentado:** 0 cópia(s)
...
- **Assinatura paths:** puncao-builder-lote-04↔puncao-venosa-e-cuidados-com-cateteres-g02+2
- **Lotes:** puncao-builder-lote-04, puncao-venosa-e-cuidados-com-cateteres-g02, puncao-venosa-e-cuidados-com-cateteres-lote-01, puncao-venosa-e-cuidados-com-cateteres-repair-lote-04-dispositivo
- **Manifest documentado:** 0 cópia(s)
- **Hashes semânticos:** 4 distintos
- **Campos:** meta.content_standard, meta.family, meta.pedagogical_branch, question_data.instruction, reverse_study_slides[0].chip_label, reverse_study_slides[0].footer_rule, reverse_study_slides[0].items.length, reverse_study_slides[0].slide_title, reverse_study_slides[1].footer_rule, reverse_study_slides[1].slide_title
...
- **Severidade:** S1
- **Pacote:** Exames Laboratoriais
- **Assinatura paths:** coleta-lote-01↔exames-laboratoriais-lote-01
- **Lotes:** coleta-lote-01, exames-laboratoriais-lote-01
- **Manifest documentado:** 0 cópia(s)
- **Hashes semânticos:** 2 distintos
- **Campos:** meta.subtopico, reverse_study_slides[0].meta.subtopico, reverse_study_slides[1].meta.subtopico, reverse_study_slides[2].meta.subtopico, reverse_study_slides[3].meta.subtopico
- **Resumo:** Divergência em metadados pedagógicos (subtópico/family/branch).
...
- **Assinatura paths:** biosseg-itu-scan↔infeccoes-biosseguranca-completo+1
- **Lotes:** biosseg-itu-scan, infeccoes-biosseguranca-completo, processo-de-enfermagem-lote-02
- **Manifest documentado:** 0 cópia(s)
- **Hashes semânticos:** 2 distintos
- **Campos:** n/d
- **Resumo:** Divergência em slots/conteúdo dos NeuroSlides entre cópias.
...
- **Severidade:** S1
- **Pacote:** Exames complementares
- **Assinatura paths:** coleta-lote-01↔exames-complementares-lote-01
- **Lotes:** coleta-lote-01, exames-complementares-lote-01
- **Manifest documentado:** 0 cópia(s)
- **Hashes semânticos:** 2 distintos
- **Campos:** meta.subtopico, reverse_study_slides[0].meta.subtopico, reverse_study_slides[1].meta.subtopico, reverse_study_slides[2].meta.subtopico, reverse_study_slides[3].meta.subtopico
- **Resumo:** Divergência em metadados pedagógicos (subtópico/family/branch).
...
- **Severidade:** S2
- **Pacote:** Punção Venosa e Cuidados com Cateteres
- **Assinatura paths:** puncao-builder-lote-04↔puncao-builder-pilot+3
- **Lotes:** puncao-builder-lote-04, puncao-builder-pilot, puncao-preview, puncao-venosa-e-cuidados-com-cateteres-g06, puncao-venosa-e-cuidados-com-cateteres-lote-01
- **Manifest documentado:** 0 cópia(s)
- **Hashes semânticos:** 3 distintos
- **Campos:** n/d
- **Resumo:** Divergência em slots/conteúdo dos NeuroSlides entre cópias.
...
- **Severidade:** S2
- **Pacote:** Verificação de Sinais Vitais
- **Assinatura paths:** nocoes-de-anatomia-lote-01↔sinais-vitais-completo+1
- **Lotes:** nocoes-de-anatomia-lote-01, sinais-vitais-completo, verificacao-de-sinais-vitais-repair-lote-01
- **Manifest documentado:** 0 cópia(s)
- **Hashes semânticos:** 2 distintos
- **Campos:** meta.subtopico, reverse_study_slides[0].chip_label, reverse_study_slides[0].footer_rule, reverse_study_slides[0].items.length, reverse_study_slides[0].meta.subtopico, reverse_study_slides[0].slide_title, reverse_study_slides[0].subject, reverse_study_slides[1].footer_rule, reverse_study_slides[1].meta.subtopico, reverse_study_slides[1].slide_title
- **Resumo:** Divergência em slots/conteúdo dos NeuroSlides entre cópias.
- **Por que unresolved:** slug sem cópia listada em manifest/registry/contrato documentado
- **Decisão humana:** Declarar manifest/registry para o slug ou revisar cópias órfãs (sem apagar automaticamente).
...
- **Assinatura paths:** curativos-e-manejo-de-feridas-lote-01↔curativos-lote-01+2
- **Lotes:** curativos-e-manejo-de-feridas-lote-01, curativos-lote-01, curativos-lote-02, curativos-lote-03
- **Manifest documentado:** 0 cópia(s)
- **Hashes semânticos:** 2 distintos
- **Campos:** reverse_study_slides[0].footer_rule, reverse_study_slides[0].items.length, reverse_study_slides[0].slide_title, reverse_study_slides[1].footer_rule, reverse_study_slides[1].steps[1], reverse_study_slides[1].steps[2], reverse_study_slides[1].steps[4], reverse_study_slides[1].steps[7], reverse_study_slides[2].content, reverse_study_slides[2].footer_rule
- **Resumo:** Divergência em slots/conteúdo dos NeuroSlides entre cópias.
- **Por que unresolved:** slug sem cópia listada em manifest/registry/contrato documentado
- **Decisão humana:** Declarar manifest/registry para o slug ou revisar cópias órfãs (sem apagar automaticamente).
...
- **Pacote:** Punção Venosa e Cuidados com Cateteres
- **Assinatura paths:** puncao-builder-lote-04↔puncao-builder-pilot+3
- **Lotes:** puncao-builder-lote-04, puncao-builder-pilot, puncao-venosa-e-cuidados-com-cateteres-g12, puncao-venosa-e-cuidados-com-cateteres-lote-01, puncao-venosa-e-cuidados-com-cateteres-repair-lote-08-drift
- **Manifest documentado:** 0 cópia(s)
- **Hashes semânticos:** 4 distintos
- **Campos:** n/d
- **Resumo:** Divergência em slots/conteúdo dos NeuroSlides entre cópias.
...
- **Severidade:** S1
- **Pacote:** Processo de Enfermagem
- **Assinatura paths:** curativos-e-manejo-de-feridas-completo↔processo-de-enfermagem-lote-01
- **Lotes:** curativos-e-manejo-de-feridas-completo, processo-de-enfermagem-lote-01
- **Manifest documentado:** 0 cópia(s)
- **Hashes semânticos:** 2 distintos
- **Campos:** meta.subtopico, reverse_study_slides[0].meta.subtopico, reverse_study_slides[1].meta.subtopico, reverse_study_slides[2].meta.subtopico, reverse_study_slides[3].meta.subtopico
- **Resumo:** Divergência em metadados pedagógicos (subtópico/family/branch).
...
- **Severidade:** S2
- **Pacote:** Processo de Enfermagem
- **Assinatura paths:** coleta-lote-01↔processo-de-enfermagem-lote-01
- **Lotes:** coleta-lote-01, processo-de-enfermagem-lote-01
- **Manifest documentado:** 0 cópia(s)
- **Hashes semânticos:** 2 distintos
...
- **Severidade:** S2
- **Pacote:** Processo de Enfermagem
- **Assinatura paths:** cuidados-na-administracao-de-medicamentos-repair-lote-01↔processo-de-enfermagem-lote-01
- **Lotes:** cuidados-na-administracao-de-medicamentos-repair-lote-01, processo-de-enfermagem-lote-01
- **Manifest documentado:** 0 cópia(s)
- **Hashes semânticos:** 2 distintos
...
- **Severidade:** S2
- **Pacote:** Processo de Enfermagem
- **Assinatura paths:** curativos-lote-01↔curativos-lote-02+2
- **Lotes:** curativos-lote-01, curativos-lote-02, curativos-lote-03, processo-de-enfermagem-lote-01
- **Manifest documentado:** 0 cópia(s)
- **Hashes semânticos:** 2 distintos
- **Campos:** n/d
- **Resumo:** Divergência em slots/conteúdo dos NeuroSlides entre cópias.
...
- **Assinatura paths:** processo-de-enfermagem-lote-01↔urgencias-e-emergencias-repair-lote-01
- **Lotes:** processo-de-enfermagem-lote-01, urgencias-e-emergencias-repair-lote-01
- **Manifest documentado:** 0 cópia(s)
- **Hashes semânticos:** 2 distintos
- **Campos:** meta.subtopico, reverse_study_slides[0].chip_label, reverse_study_slides[0].footer_rule, reverse_study_slides[0].items.length, reverse_study_slides[0].meta.subtopico, reverse_study_slides[0].slide_title, reverse_study_slides[1].chip_label, reverse_study_slides[1].footer_rule, reverse_study_slides[1].meta.subtopico, reverse_study_slides[1].slide_title
- **Resumo:** Divergência em slots/conteúdo dos NeuroSlides entre cópias.
...
- **Severidade:** S2
- **Pacote:** Processo de Enfermagem
- **Assinatura paths:** infeccoes-sexualmente-transmissiveis-ists-repair-lote-01↔processo-de-enfermagem-lote-01
- **Lotes:** infeccoes-sexualmente-transmissiveis-ists-repair-lote-01, processo-de-enfermagem-lote-01
- **Manifest documentado:** 0 cópia(s)
- **Hashes semânticos:** 2 distintos
- **Campos:** meta.subtopico, reverse_study_slides[0].chip_label, reverse_study_slides[0].footer_rule, reverse_study_slides[0].items.length, reverse_study_slides[0].meta.subtopico, reverse_study_slides[0].slide_title, reverse_study_slides[1].chip_label, reverse_study_slides[1].footer_rule, reverse_study_slides[1].meta.subtopico, reverse_study_slides[1].slide_title
- **Resumo:** Divergência em slots/conteúdo dos NeuroSlides entre cópias.
