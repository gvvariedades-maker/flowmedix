# Relatório nota-10 — saude-mental
...
|----------|------|-------|----|
| applied / total | 100% | 37/37 | ✅ |
| status registry | applied | applied | ✅ |
| production_status | production_ready | production_ready | ✅ |
| Bespoke 4/4 ramos fortes | N/N ou N/A | briefs INDEX; RAPS React só com Implementar molde: | ⚠ |
...
| Playwright L3 | PASS ou N/A | pendente se molde_* | ⚠ |
...
| Barra visual | verde | conteúdo verde; RAPS bespoke = backlog | ⚠ |


> **Nota Onda 3:** named 5→0; VF 1→0
...
|----------|----------------------|-------------|----------|
| Slugs applied | 16/16 | 37/37 | proporcional |
...
|----|-----|-----------|---------------|
| B1 | visual/L3 | RAPS React só com Implementar molde: | Implementar molde: só com pedido explícito |
...
| 37/37 | N/A-ok | ok | N/A | pendente | ok | production_ready | verde | parcial | RAPS React só com Implementar molde: |
```
