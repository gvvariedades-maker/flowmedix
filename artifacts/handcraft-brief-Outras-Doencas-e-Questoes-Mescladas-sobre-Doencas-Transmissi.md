# Handcraft briefing — Outras Doenças e Questões Mescladas sobre Doenças Transmissíveis
...
```bash
npm run catalog:export-lote -- --lote=pacote-completo --subtopico="Outras Doenças e Questões Mescladas sobre Doenças Transmissíveis" --limit=10000
