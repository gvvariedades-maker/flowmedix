# Pipeline completo — Atenção Básica / Saúde da Família
...
```bash
npm run audit:subtopico-inventory -- --subtopico="Atenção Básica / Saúde da Família"
# Se drift: conversa Classify: Atenção Básica / Saúde da Família
# Subtópico novo: conversa Mapeamento L3: Atenção Básica / Saúde da Família
npm run catalog:export-lote -- --lote=<pacote>-completo --subtopico="Atenção Básica / Saúde da Família" --limit=10000
# Criar entrada em handcraft-registry.json se ausente
# npm run cluster:<pacote> (se existir)
npm run audit:golden-anchor-gate -- --subtopico="Atenção Básica / Saúde da Família"
# Se gate=block: Criar âncoras: Atenção Básica / Saúde da Família (skill avant-golden-anchor-bootstrap)
npm run anchor:brief -- --subtopico="Atenção Básica / Saúde da Família"
```
...
|-------|-------------------|
| Taxonomia | `Classify: Atenção Básica / Saúde da Família` (se inventário com drift) |
| L3 | `Mapeamento L3: Atenção Básica / Saúde da Família` (subtópico novo ou sem cluster) |
| Brief handcraft | `npm run handcraft:brief -- --subtopico="Atenção Básica / Saúde da Família"` |
