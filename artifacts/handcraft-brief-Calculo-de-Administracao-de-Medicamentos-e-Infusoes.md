# Handcraft briefing — Cálculo de Administração de Medicamentos e Infusões
...
```bash
npm run catalog:export-lote -- --lote=pacote-completo --subtopico="Cálculo de Administração de Medicamentos e Infusões" --limit=10000
