...
Gerado em: 2026-08-06T01:02:54.572Z
...
| Clusters mapeados | 239 |
| Slugs auditados | 4028 |
| ok_existente | 12 |
| ok_generico | 107 |
| ramo_novo | 76 |
| molde_inedito | 25 |
...
|-----------|-------------------|
| Imunização | 28 |
| Cuidados na Administração de Medicamentos | 13 |
| Cálculo de Administração de Medicamentos e Infusões | 11 |
| Saúde do Adolescente | 8 |
...
| Saúde do Adolescente | Gravidez / sigilo | 2 | 12.5% | ok_existente | `adolescente_etica_sigilo` | adolescent-care-pillars-deck · adolescent-speak-barrier-boar… |
...
| Saúde do Adolescente | Genérico MS / EXCETO / promoção | 6 | 37.5% | ok_existente | `adolescente_generico` | adolescent-care-pillars-deck · adolescent-speak-barrier-boar… |
...
| Imunização | INCORRETA / EXCETO | 42 | 7.3% | molde_redesign | `imunizacao_exceto` | pni-exceto-command-hub · pni-exceto-rule-board · pni-exceto-… |
...
| Atenção Básica / Saúde da Família | ACS — atribuições, visita e território | 66 | 38.6% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Atenção Básica / Saúde da Família | Atenção Básica — conceito geral | 66 | 38.6% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Atenção Básica / Saúde da Família | eSF — composição, carga e modalidades | 18 | 10.5% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Atenção Básica / Saúde da Família | PNAB / princípios e atributos da APS | 6 | 3.5% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Atenção Básica / Saúde da Família | Vigilância / ACE no território | 6 | 3.5% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Atenção Básica / Saúde da Família | Técnico de enfermagem na AB | 5 | 2.9% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Atenção Básica / Saúde da Família | Slug segment fora do pacote (drift?) | 3 | 1.8% | ok_generico | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Atenção Básica / Saúde da Família | Imunização (drift?) | 1 | 0.6% | ok_generico | `generico` | morphological · reference_table · vertical · compare (genéri… |
...
| Noções de Anatomia | Terminologia e planos anatômicos | 15 | 32.6% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Noções de Anatomia | Sistema esquelético / ossos e articulações | 14 | 30.4% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Noções de Anatomia | Anatomia — conceito geral | 7 | 15.2% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Noções de Anatomia | Sistema cardiovascular | 7 | 15.2% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Noções de Anatomia | Sistema muscular | 2 | 4.3% | ok_generico | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Noções de Anatomia | Cavidades e topografia | 1 | 2.2% | ok_generico | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Epidemiologia e Vigilância Epidemiológica | Notificação compulsória / SINAN / lista nacional | 76 | 34.9% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Epidemiologia e Vigilância Epidemiológica | Epidemiologia — conceito geral | 47 | 21.6% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Epidemiologia e Vigilância Epidemiológica | Indicadores — incidência, prevalência, mortalidade, letalidade | 34 | 15.6% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Epidemiologia e Vigilância Epidemiológica | Vigilância epidemiológica — conceito e ações | 26 | 11.9% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Epidemiologia e Vigilância Epidemiológica | Atenção básica (drift?) | 10 | 4.6% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Epidemiologia e Vigilância Epidemiológica | Ocorrência — endemia, epidemia, pandemia, surto | 10 | 4.6% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Epidemiologia e Vigilância Epidemiológica | Cadeia de transmissão / períodos / histórico natural | 8 | 3.7% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Epidemiologia e Vigilância Epidemiológica | V/F — conceitos epidemiológicos | 2 | 0.9% | ok_generico | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Epidemiologia e Vigilância Epidemiológica | EXCETO / INCORRETA — epidemiologia | 2 | 0.9% | ok_generico | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Epidemiologia e Vigilância Epidemiológica | Imunização (drift?) | 2 | 0.9% | ok_generico | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Epidemiologia e Vigilância Epidemiológica | Doenças transmissíveis clínicas (drift?) | 1 | 0.5% | ok_generico | `generico` | morphological · reference_table · vertical · compare (genéri… |

## Slugs (amostra com branch inferido)

- `—`: 600
- `imunizacao_calendario`: 427
- `sae_etapas`: 218
- `via_vf_absorcao`: 191
- `calc_dose_equivalencia`: 133
- `urgencias_generico`: 128
- `mulher_prenatal`: 121
- `epi_notificacao_compulsoria`: 83
- `cam_certos_vf_caso`: 82
- `ab_acs_territorio`: 80
- `epi_vigilancia_acoes`: 60
- `urgencias_exceto_conduta`: 56
- `imunizacao_cadeia_frio`: 55
- `urgencias_rcp_sbv`: 54
- `imunizacao_generico`: 51
- `biosseg_generico`: 48
- `ab_generico`: 45
- `coleta_generico`: 45
- `epi_indicadores`: 44
...
- `sae_documentacao`: 38
- `sp_generico`: 37
- `coleta_tubos_ordem`: 36
- `coleta_nao_sanguinea`: 36
- `curativos_tecnica_assepsia`: 34
- `mulher_generico`: 34
- `puncao_flebite`: 31
- `urgencias_choque`: 31
- `cam_generico`: 29
- `imunizacao_exceto`: 28
- `puncao_dispositivo`: 25
- `mulher_puerperio`: 25
- `bacterianas_tuberculose`: 24
- `anat_terminologia_planos`: 24
- `perioperatorio_pre_operatorio`: 24
- `perioperatorio_pos_operatorio`: 23
- `via_tecnica_admin`: 23
- `curativos_cobertura_selecao`: 22
- `mulher_parto`: 21
- `ab_esf_composicao`: 20
- `sae_exceto`: 20
- `puncao_generico`: 19
- `via_generico`: 19
- `cme_vf_ce`: 18
- `urgencias_avc_iam`: 18
- `coleta_hemocultura`: 17
- `curativos_generico`: 17
- `curativos_ferida_cirurgica`: 17
- `trabalho_ergonomia`: 17
- `mulher_mama`: 17
- `curativos_desbridamento`: 16
- `crianca_generico`: 16
- `cme_autoclave_metodos`: 15
- `curativos_exceto_incorreta`: 15
- `curativos_bandagem_imobilizacao`: 15
- `bacterianas_generico`: 15
- `epi_generico`: 15
- `ab_te_aps`: 14
- `coleta_jejum_preparo`: 14
- `imunizacao_vf_intervalos`: 14
- `perioperatorio_isc`: 14
- `crianca_aleitamento_nutricao`: 14
- `urgencias_engasgo`: 14
- `urgencias_vf_protocolo`: 13
- `coleta_tecnica_venosa`: 13
- `sp_eventos_adversos`: 13
- `mental_raps_legis`: 12
...
- `sp_identificacao`: 11
- `urgencias_xabcde_trauma`: 11
- `epi_cadeia_transmissao`: 10
- `mulher_planejamento`: 10
- `cme_generico`: 9
- `coleta_capilar_glicemia`: 9
- `trabalho_nr15_reference`: 9
- `epi_ocorrencia_agravos`: 9
- `anat_cardiovascular`: 9
- `sae_generico`: 9
- `puncao_exceto`: 9
- `urgencias_rcp_pediatrico`: 9
- `cam_alto_risco`: 8
- `historia_humanizacao`: 8
- `anat_esqueleto`: 8
- `puncao_periferica_antissepsia`: 8
- `crianca_desidratacao`: 8
- `ab_pnab_principios`: 7
- `ab_vigilancia_ads`: 7
- `cam_documentacao`: 7
- `promocao_educacao_prevencao`: 7
- `crianca_aps_puericultura`: 7
- `mental_depressao`: 7
- `cme_processamento_conceito`: 6
...
- `urgencias_convulsao`: 6
- `curativos_termoterapia`: 5
- `curativos_estomia`: 5
- `historia_comunicacao_etica`: 5
- `perioperatorio_generico`: 5
- `puncao_tempo`: 5
- `adolescente_etica_sigilo`: 5
- `adolescente_antropometria`: 5
- `vitals_pa_tecnica`: 5
- `urgencias_anafilaxia`: 5
...
- `trabalho_vf_nr32`: 3
- `historia_generico`: 3
- `adolescente_generico`: 3
- `crianca_neonatologia`: 3
- `crianca_desenvolvimento`: 3
- `sp_metas_internacionais`: 3
- `vitals_pediatrico_faixas`: 3
- `feridas_cicatrizacao`: 2
- `feridas_curativo_tipo`: 2
- `biosseg_iras_itu_cateter`: 2
- `anat_generico`: 2
- `anat_muscular`: 2
