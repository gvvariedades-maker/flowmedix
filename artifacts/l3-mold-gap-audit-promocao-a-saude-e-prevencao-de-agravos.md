...
Gerado em: 2026-07-20T15:34:55.403Z
...
| Promoção à Saúde e Prevenção de Agravos | Promoção à saúde — conceito geral | 50 | 45.5% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Promoção à Saúde e Prevenção de Agravos | Atenção básica e educação em saúde | 17 | 15.5% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Promoção à Saúde e Prevenção de Agravos | Promoção × prevenção × proteção × recuperação | 17 | 15.5% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Promoção à Saúde e Prevenção de Agravos | Determinantes sociais e políticas públicas | 12 | 10.9% | ramo_novo | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Promoção à Saúde e Prevenção de Agravos | Imunização (drift?) | 4 | 3.6% | ok_generico | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Promoção à Saúde e Prevenção de Agravos | V/F I–II–III sobre legislação sanitária | 3 | 2.7% | ok_generico | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Promoção à Saúde e Prevenção de Agravos | Sinais vitais (drift?) | 2 | 1.8% | ok_generico | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Promoção à Saúde e Prevenção de Agravos | Princípios e direitos (CF Art. 196, universalidade, integralidade) | 1 | 0.9% | ok_generico | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Promoção à Saúde e Prevenção de Agravos | Lei 8.080 — Art. 4º composição do SUS | 1 | 0.9% | ok_generico | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Promoção à Saúde e Prevenção de Agravos | Lei 8.142 — controle social / CNS | 1 | 0.9% | ok_generico | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Promoção à Saúde e Prevenção de Agravos | Saúde do idoso (drift?) | 1 | 0.9% | ok_generico | `generico` | morphological · reference_table · vertical · compare (genéri… |
| Promoção à Saúde e Prevenção de Agravos | EXCETO / INCORRETA sobre SUS | 1 | 0.9% | ok_generico | `generico` | morphological · reference_table · vertical · compare (genéri… |
...
- `mulher_mama`: 1
- `adolescente_saude_mental`: 1
- `mulher_papanicolau`: 1
- `urgencias_rcp_sbv`: 1
- `trabalho_vf_nr32`: 1
- `trabalho_nr15_reference`: 1