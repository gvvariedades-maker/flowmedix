# Pipeline completo — Concordância verbal e nomina
...
```bash
npm run audit:subtopico-inventory -- --subtopico="Concordância verbal e nomina"
# Se drift: conversa Classify: Concordância verbal e nomina
# Subtópico novo: conversa Mapeamento L3: Concordância verbal e nomina
npm run catalog:export-lote -- --lote=<pacote>-completo --subtopico="Concordância verbal e nomina" --limit=10000
# Criar entrada em handcraft-registry.json se ausente
# npm run cluster:<pacote> (se existir)
npm run audit:golden-anchor-gate -- --subtopico="Concordância verbal e nomina"
# Se gate=block: Criar âncoras: Concordância verbal e nomina (skill avant-golden-anchor-bootstrap)
npm run anchor:brief -- --subtopico="Concordância verbal e nomina"
```
...
|-------|-------------------|
| Taxonomia | `Classify: Concordância verbal e nomina` (se inventário com drift) |
| L3 | `Mapeamento L3: Concordância verbal e nomina` (subtópico novo ou sem cluster) |
| Brief handcraft | `npm run handcraft:brief -- --subtopico="Concordância verbal e nomina"` |
